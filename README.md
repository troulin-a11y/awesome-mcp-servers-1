...
- <img src="https://getbeachfinder.com/logo.png" height="14"/> [BeachFinder](https://github.com/troulin-a11y/BeachFinder-mcp) - Search and compare 184,900 beaches, lakes, and swimming spots with current planning signals, water activities, public providers, and canonical BeachFinder links through a read-only remote MCP server
